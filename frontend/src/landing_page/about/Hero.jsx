        ...
        <div className='container'>
            <div className='row'>
                <div className='text-center'>
                    <h1 style={{fontSize:"1.4rem", padding:"100px 0", color:"#424242", lineHeight:"2rem"}}>We pioneered the discount broking model in India. <br />
                        Now, we are breaking ground with our technology.</h1>
                </div>
            </div>

            <div className='row p-3 p-md-5 border-top text-muted border-bottom' style={{fontSize: "1rem", lineHeight: "1.8", marginBottom: "15px", display: "flex", gap: "20px", justifyContent: "center"}}>
