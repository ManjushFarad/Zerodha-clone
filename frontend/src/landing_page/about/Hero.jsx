...
function Hero() {
    return ( 
        <div className='container'>
            ...
            <div className='row p-5  border-top text-muted border-bottom' style={{fontSize: "1rem",lineHeight: "1.8",marginBottom: "15px",display:"flex",gap:"30px", justifyContent:"center"}}>
